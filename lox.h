...
#define LOX_FOREACH_CORE(X)\
  ...
  X(xrTryCreateSpatialGraphStaticNodeBindingMSFT)\
  X(xrDestroySpatialGraphNodeBindingMSFT)\
  X(xrGetSpatialGraphNodeBindingPropertiesMSFT)\
  ...
  X(xrSetEnvironmentDepthEstimationVARJO)\
  X(xrEnumerateReprojectionModesMSFT)\
  X(xrCreateSpatialAnchorFB)\
  X(xrGetSpaceUuidFB)\
  X(xrEnumerateSpaceSupportedComponentsFB)\
  X(xrSetSpaceComponentStatusFB)\
  X(xrGetSpaceComponentStatusFB)\
  X(xrCreateTriangleMeshFB)\
  X(xrDestroyTriangleMeshFB)\
  X(xrTriangleMeshGetVertexBufferFB)\
  X(xrTriangleMeshGetIndexBufferFB)\
  X(xrTriangleMeshBeginUpdateFB)\
  X(xrTriangleMeshEndUpdateFB)\
  X(xrTriangleMeshBeginVertexBufferUpdateFB)\
  X(xrTriangleMeshEndVertexBufferUpdateFB)\
  ...
  X(xrPassthroughLayerPauseFB)\
  X(xrPassthroughLayerResumeFB)\
  X(xrPassthroughLayerSetStyleFB)\
  X(xrCreateGeometryInstanceFB)\
  X(xrDestroyGeometryInstanceFB)\
  X(xrGeometryInstanceSetTransformFB)\
  X(xrQuerySpacesFB)\
  X(xrRetrieveSpaceQueryResultsFB)\
  X(xrSaveSpaceFB)\
  X(xrEraseSpaceFB)\
  X(xrGetSpaceContainerFB)\
  X(xrGetSpaceBoundingBox2DFB)\
  X(xrGetSpaceBoundingBox3DFB)\
  X(xrGetSpaceSemanticLabelsFB)\
  X(xrGetSpaceBoundary2DFB)\
  X(xrGetSpaceRoomLayoutFB)\
  X(xrPassthroughLayerSetKeyboardHandsIntensityFB)\
  ...
  X(xrCreateFacialTrackerHTC)\
  X(xrDestroyFacialTrackerHTC)\
  X(xrGetFacialExpressionsHTC)\
  X(xrCreatePassthroughHTC)\
  X(xrDestroyPassthroughHTC)\
  X(xrEnumerateViveTrackerPathsHTCX)\
  X(xrSetMarkerTrackingVARJO)\
  X(xrSetMarkerTrackingTimeoutVARJO)\
  X(xrSetMarkerTrackingPredictionVARJO)\
  X(xrGetMarkerSizeVARJO)\
  X(xrCreateMarkerSpaceVARJO)\
  X(xrSetDigitalLensControlALMALENCE)\
  X(xrSetViewOffsetVARJO)\
  X(xrEnumeratePerformanceMetricsCounterPathsMETA)\
  X(xrSetPerformanceMetricsStateMETA)\
  X(xrGetPerformanceMetricsStateMETA)\
  X(xrQueryPerformanceMetricsCounterMETA)\
  X(xrApplyFoveationHTC)

#ifdef XR_USE_TIMESPEC
#define LOX_FOREACH_TIMESPEC(X)\
...
#define LOX_FOREACH(X)\
  LOX_FOREACH_CORE(X)\
  LOX_FOREACH_TIMESPEC(X)\
  LOX_FOREACH_ANDROID(X)\
  LOX_FOREACH_WIN32(X)\
  LOX_FOREACH_D3D11(X)\
  LOX_FOREACH_D3D12(X)\
  LOX_FOREACH_OPENGL(X)\
  LOX_FOREACH_ES(X)\
  LOX_FOREACH_VULKAN(X)
// === >8 ===
